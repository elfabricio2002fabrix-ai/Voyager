...
const AuthModal = ({ show, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage({ type: 'success', text: 'Éxito!' })
        if (mode !== 'reset') {
      ...
      {show && (
        ...
        >
          <motion.div
            ...
            className="glass-strong rounded-3xl max-w-md w-full p-8"
          >
            {/* Header */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mb-6">
              ...
              >
                {loading ? 'Procesando...' : mode === 'login' ? 'Entrar' : mode === 'signup' ? 'Crear Cuenta' : 'Enviar'}
              </button>
            </form>
              ...
              <>
                <div className="relative mb-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 glass-strong text-gray-400">O continúa con</span>
                  </div>
                </div>
                ...
                <>
                  <p>
                    ...
                    <button
                      ...
                      className="text-voyager-blue hover:underline"
                    >
                      Regístrate
                    </button>
                  </p>
                  <button
                    ...
                    className="mt-2 text-voyager-blue hover:underline"
                  >
